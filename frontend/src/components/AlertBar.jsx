  ...
  useEffect(() => {
    ...
    for (const [zone, readings] of Object.entries(data.recent)) {
      if (readings.is_anomaly && readings.id !== lastAlertRef.current) {
        ...
        fetch(`${API_URL}/api/trigger-email`, {
          method: 'POST',
  ...
  return (
    <>
      <div className="fixed top-8 right-8 z-[100] w-full max-w-[400px] pointer-events-none">
        <div
          className={`glass-aurora pointer-events-auto flex items-stretch gap-0 p-0 rounded-2xl overflow-hidden transition-all duration-700 ease-premium shadow-2xl ${visible && alertContent
        ...
        >
          ...
          <div className="flex-1 p-5 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-[11px] font-bold text-white/40 tracking-tight mt-1">
